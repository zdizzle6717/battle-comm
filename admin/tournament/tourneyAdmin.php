...
<script type="text/javascript">
  ...
  /* dmxDataSet name "tournamentAdminFilter" */
       jQuery.dmxDataSet(
         {"id": "tournamentAdminFilter", "url": "../../dmxDatabaseSources/tournamentAdminFilterClear.php", "data": {"limit": "25"}, "dataSourceType": "database", "dataType": "jsonp"}
       );
  /* END dmxDataSet name "tournamentAdminFilter" */

  /* dmxDataSet name "tournamentAdminFilterCleared" */
       jQuery.dmxDataSet(
         {"id": "tournamentAdminFilterCleared", "url": "../../dmxDatabaseSources/tournamentAdminFilterClear.php", "data": {"limit": "25"}, "dataSourceType": "database", "dataType": "jsonp"}
       );
  /* END dmxDataSet name "tournamentAdminFilterCleared" */
</script>
...
<!-- End User Level Navigation -->
            ...
            <p><strong><a href="../../tool/tournamentAdmin/index.php">Tournament Admin</a></strong> </p>
            <button type="button" class="button-link" onclick="location.href='../../tool/tournamentAdmin/tournament_insert.php'">Create New Tournament</button>
        ...
        <tbody>
          <tr data-binding-repeat="{{tournamentAdminFilter.data}}" data-binding-id="repeat1">
            ...
            <td><a href="../../tool/tourney_SetupRevA.php?tourney={{tournament_id}}&gs={{game_id}}">Configure Tournament</a></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
