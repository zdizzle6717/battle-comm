...
<form enctype="multipart/form-data"  class="Basic_Default" id="Update_Basic_Default" name="Update_Basic_Default" method="post" action="<?php echo(htmlentities($_SERVER["PHP_SELF"], ENT_QUOTES)."?".$_SERVER["QUERY_STRING"]); ?>">
  ...
  <input id="venue_Street_Address" name="venue_Street_Address" type="text" value="<?php echo((isset($_GET["invalid"])?ValidatedField("venueupdate","venue_Street_Address"):"".$row_WADAvenue["venue_Street_Address"]."")); ?>" class="formTextfield_Large" tabindex="3" title="Please enter a value.">
    </div> 
...
do {  
?>
        <option value="<?php echo $row_WADAMenuvenue_state['state_abbr']?>"<?php if (!(strcmp($row_WADAMenuvenue_state['state_abbr'], (isset($_GET["invalid"])?ValidatedField("venueupdate","venue_state"):"".$row_WADAvenue["venue_state"]."")))) {echo "selected=\"selected\"";} ?>><?php echo $row_WADAMenuvenue_state['state_name']?></option>
        <?php
...
?><span class="serverInvalidState" id="venue_email_ServerError">Please enter a value.</span><?php //WAFV_Conditional venue_update.php venueupdate(4:)
  ...
  <input id="venue_website" name="venue_website" type="text" value="<?php echo((isset($_GET["invalid"])?ValidatedField("venueupdate","venue_website"):"".$row_WADAvenue["venue_website"]."")); ?>" class="formTextfield_Medium" tabindex="10" title="Please enter a value.">
    </div> 
  ...
  <input id="venue_contact_name" name="venue_contact_name" type="text" value="<?php echo((isset($_GET["invalid"])?ValidatedField("venueupdate","venue_contact_name"):"".$row_WADAvenue["venue_contact_name"]."")); ?>" class="formTextfield_Medium" tabindex="11" title="Please enter a value.">
    ...
    <div class="lineGroup"> <label for="venue_about" class="sublabel" > About:</label><div style="display:inline-block"><?php
// The initial value to be displayed in the editor.
$CKEditor_initialValue = "".((isset($_GET["invalid"])?ValidatedField("venueupdate","venue_about",false):"".$row_WADAvenue["venue_about"].""))  ."";
...
?></div>
    ...
    <div class="lineGroup"> <label for="venue_notes" class="sublabel" > Notes:</label>
  ...
  <input id="venue_outriders" name="venue_outriders" type="text" value="<?php echo((isset($_GET["invalid"])?ValidatedField("venueupdate","venue_outriders"):"".$row_WADAvenue["venue_outriders"]."")); ?>" class="formTextfield_Small" tabindex="13" title="Please enter a value.">
    </div> 
  ...
  <input id="venue_map_URL" name="venue_map_URL" type="text" value="<?php echo((isset($_GET["invalid"])?ValidatedField("venueupdate","venue_map_URL"):"".$row_WADAvenue["venue_map_URL"]."")); ?>" class="formTextfield_XLarge" tabindex="15" title="Please enter a value.">
    </div> 
