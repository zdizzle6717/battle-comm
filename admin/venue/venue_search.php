...
<form class="Basic_Default" id="Search_Basic_Default" name="Search_Basic_Default" method="get" action="venue_results.php">
  ...
  <input id="venue_city" name="venue_city" type="text" value="<?php echo((isset($_GET["venue_city"])?$_GET["venue_city"]:"")); ?>" class="formTextfield_Medium" tabindex="3" title="Please enter a value.">
    </div> 
    <div class="lineGroup"> <label for="venue_state" class="sublabel" > State:</label>
      <select class="formMenufield_Small" name="venue_state" id="venue_state" rel="<?php echo((isset($_GET["venue_state"])?$_GET["venue_state"]:"")); ?>" tabindex="4" title="Please enter a value.">
