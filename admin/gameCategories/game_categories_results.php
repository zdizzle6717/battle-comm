...
?>
<?php
$maxRows_WADAgame_categories = 1000;
...
$query_WADAgame_categories = "SELECT game_cat_id, game_category FROM game_categories";
...
$WADAgame_categories = mysql_query($query_limit_WADAgame_categories, $local) or die(mysql_error());
...
if (isset($_GET['totalRows_WADAgame_categories'])) {
  ...
  $all_WADAgame_categories = mysql_query($query_WADAgame_categories);
  ...
  <div class="WADAResults">
    <div class="WADAResultsNavigation"><wa:insertbutton>
			<div class="WADAResultsInsertButton">
				<input type="button" value="Insert" class="formButton Modular" id="Insert" name="Insert" onclick="document.location.href='game_categories_insert.php';" />
			</div></wa:insertbutton>
...
<?php echo(isset($_GET["pageNum_WADAgame_categories"])?"&pageNum_WADAgame_categories=".intval($_GET["pageNum_WADAgame_categories"]):""); ?>" ><?php echo($row_WADAgame_categories['game_category']); ?></a></td>
		...
		<td class="WADAResultsEditButtons" nowrap="nowrap"><input type="button" class="formButton ResultsPageButton Modular DetailButton" value="" onclick="document.location.href='game_categories_detail.php?game_cat_id=<?php echo($row_WADAgame_categories['game_cat_id']); ?>
<?php echo(isset($_GET["pageNum_WADAgame_categories"])?"&pageNum_WADAgame_categories=".intval($_GET["pageNum_WADAgame_categories"]):""); ?>';"/><input type="button" class="formButton ResultsPageButton Modular UpdateButton" value="" onclick="document.location.href='game_categories_update.php?game_cat_id=<?php echo($row_WADAgame_categories['game_cat_id']); ?>
<?php echo(isset($_GET["pageNum_WADAgame_categories"])?"&pageNum_WADAgame_categories=".intval($_GET["pageNum_WADAgame_categories"]):""); ?>';"/><input type="button" class="formButton ResultsPageButton Modular DeleteButton" value="" onclick="document.getElementById('WADADeleteRecordID').value=<?php echo($row_WADAgame_categories['game_cat_id']); ?>;document.getElementById('deleteBox').style.display = 'block';document.getElementById('deleteMessage').style.display = 'table';" /></td>
        </tr>
<?php } while ($row_WADAgame_categories = mysql_fetch_assoc($WADAgame_categories)); ?>
    ...
    <div class="WADAResultsNavigation">
      ...
      <div class="WADAResultsNavBottom">
        <table border="0" cellpadding="0" cellspacing="0" class="WADAResultsNavTable">
          <tr valign="middle">
            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><?php if ($pageNum_WADAgame_categories > 0) { // Show if not first page ?><input type="button" value="<<" class="formButton ResultsNavButton Modular" id="First_2" name="First_2" onclick="document.location.href='<?php printf("%s?pageNum_WADAgame_categories=%d%s", $currentPage, 0, $queryString_WADAgame_categories); ?>';" /><?php } // Show if not first page ?></td>
            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><?php if ($pageNum_WADAgame_categories > 0) { // Show if not first page ?><input type="button" value="<" class="formButton ResultsNavButton Modular" id="Previous_2" name="Previous_2" onclick="document.location.href='<?php printf("%s?pageNum_WADAgame_categories=%d%s", $currentPage, max(0, $pageNum_WADAgame_categories - 1), $queryString_WADAgame_categories); ?>';" /><?php } // Show if not first page ?></td>
            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><?php if ($pageNum_WADAgame_categories < $totalPages_WADAgame_categories) { // Show if not last page ?><input type="button" value=">" class="formButton ResultsNavButton Modular" id="Next_2" name="Next_2" onclick="document.location.href='<?php printf("%s?pageNum_WADAgame_categories=%d%s", $currentPage, min($totalPages_WADAgame_categories, $pageNum_WADAgame_categories + 1), $queryString_WADAgame_categories); ?>';" /><?php } // Show if not last page ?></td>
            <td class="WADAResultsNavButtonCell" nowrap="nowrap"><?php if ($pageNum_WADAgame_categories < $totalPages_WADAgame_categories) { // Show if not last page ?><input type="button" value=">>" class="formButton ResultsNavButton Modular" id="Last_2" name="Last_2" onclick="document.location.href='<?php printf("%s?pageNum_WADAgame_categories=%d%s", $currentPage, $totalPages_WADAgame_categories, $queryString_WADAgame_categories); ?>';" /><?php } // Show if not last page ?></td>
          </tr>
        </table>
      </div>
    </div>
