...
<a name="top"></a>
	...
	<div id="WADADetails">
			...
			<tr>
				...
				<td class="DetailsPage"><?php echo($row_WADAgame_categories['game_category']); ?></td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
				  ...
				  <td><input type="button" value="Top" class="formButton Modular" id="Top" name="Top" onclick="window.location.hash='top';" /></td>
					<td><input type="button" value="Update" class="formButton Modular" id="Update" name="Update" onclick="document.location.href = 'game_categories_update.php?game_cat_id=<?php echo($row_WADAgame_categories["game_cat_id"]); ?>
<?php echo(isset($_GET["pageNum_WADAgame_categories"])?"&pageNum_WADAgame_categories=".intval($_GET["pageNum_WADAgame_categories"]):""); ?>';" /></td>
					...
					<td><input type="button" value="Back To Results" class="formButton Modular" id="BackToResults" name="BackToResults" onclick="document.location.href = 'game_categories_results.php<?php echo(isset($_GET["pageNum_WADAgame_categories"])?"?pageNum_WADAgame_categories=".intval($_GET["pageNum_WADAgame_categories"]):""); ?>';" /></td>
				   </tr>
			</table>
		</div></span>
        </fieldset>
