    ...
    'config': {
      ...
      'validate': {
        'payload': {
          ...
          'identifier': Joi.string().valid('playerIcon', 'photoStream', 'newsPostPhoto', 'gameSystemPhoto', 'manufacturerPhoto', 'productPhoto', 'productPhotoFront', 'productPhotoBack', 'bannerImage').required(),
