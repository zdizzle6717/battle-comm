...
// Files
{
  ...
  'config': {
    ...
    'validate': {
      'payload': {
        'AchievementId': _joi2.default.optional(),
        ...
        'identifier': _joi2.default.string().valid('achievement', 'playerIcon', 'photoStream', 'newsPostPhoto', 'gameSystemPhoto', 'manufacturerPhoto', 'productPhoto', 'productPhotoFront', 'productPhotoBack', 'bannerImage').required(),
