...
var files = {
    create: function create(request, reply) {
        _models2.default.File.create({
            'AchievementId': request.payload.AchievementId,
    ...
    add: function add(request, reply) {
        ...
        if (!data.path || !data.fileSize) {
            ...
            var location = __dirname + '/../../../dist' + _envVariables2.default.uploadPath + data.path;
                ...
                data.file.on('end', function (err) {
                    ...
                    if (resizeArray.length > 0) {
                        ...
                        resizeArray.forEach(function (resizeConfig) {
                            ...
                            // NOTE: If this fails, it is likely that imagemagick is not installed on the machine
    ...
    delete: function _delete(request, reply) {
        ...
        _models2.default.File.find({
            ...
            var locationPath = __dirname + '/../../../dist' + file.locationUrl;
