...
$result = $conn->query("SELECT news_id, news_title, featured_image, news_callout, news_body, news_author, news_date_submitted, game_system, parent, tags FROM bc_news");
