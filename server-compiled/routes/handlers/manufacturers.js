...
var manufacturers = {
  get: function get(request, reply) {
    _models2.default.Manufacturer.find({
      'where': {
  ...
  getAll: function getAll(request, reply) {
    _models2.default.Manufacturer.findAll({
      'include': [{
        'model': _models2.default.GameSystem
      }]
    }).then(function (response) {
  ...
  create: function create(request, reply) {
    _models2.default.Manufacturer.create({
  ...
  'search': function search(request, reply) {
    ...
    _models2.default.Manufacturer.findAndCountAll({
  ...
  delete: function _delete(request, reply) {
    _models2.default.Manufacturer.destroy({
      'where': {
        'id': request.params.id
      }
    }).then(function (response) {
