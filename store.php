...
<script type="text/javascript">
  /* dmxDataSet name "venue" */
       jQuery.dmxDataSet(
         {"id": "venue", "url": "dmxDatabaseSources/venueDetail.php", "data": {"ven": "{{$URL.ven}}", "limit": "25"}, "dataSourceType": "database", "dataType": "jsonp"}
       );
  /* END dmxDataSet name "venue" */
</script>
</head>
        		...
        		<div class="full_content col" >
                    <div class="frame_u row">
                        <div class="frame_u_bar_full col">
                        	<div class="title_large"><img src="images/Titles/Store.png" alt=""/></div>
                        </div>
