...
$cfg = <<<JSON
{"type": "update", "table": "user_login", "values": [{"table": "user_login", "column": "user_icon", "value": {"from": "form", "value": "user_icon", "required": false, "default": ""}}], "wheres": [{"table": "user_login", "column": "id", "bool": "and", "operator": "=", "value": {"from": "form", "value": "id", "required": true, "default": ""}}]}
JSON;
