...
class PlayerAllySearch extends React.Component {
    constructor() {
        super();
	...
	handlePageChange(pageNumber = 1, e) {
		...
		UserFriendService.search({
			'username': this.props.match.params.playerHandle,
			'pageSize': 10,
        ...
        return (
            <ViewWrapper headerImage="/images/Titles/Player_Ally_Search.png" headerAlt="Player Ally Search">
				<div className="small-12 columns">
					<h2>{`${this.props.match.params.playerHandle}'s`} allies</h2>
					{
...
export default withRouter(connect(mapStateToProps, null)(PlayerAllySearch));
