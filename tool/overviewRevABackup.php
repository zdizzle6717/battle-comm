...
**testing data (ID: <?php echo($GamePlayers->getColumnVal("tourney_game_player_id")); ?> /////TourneyPlayersID: <?php echo($tournament_players->getColumnVal("tournament_players_id")); ?>)**
<form action="overviewRevA.php" method="post" name="player_results_submit" id="player_results_submit">
...
?>
      <tr>
        ...
        <td style="text-align: center"><input name="tiebreaker[]" type="checkbox" id="tiebreaker[]" value="<?php echo($MatchedTiebreakers->getColumnVal("tiebreaker_points")); ?>"></td>
      </tr>
      <?php
...
<ul>
  <li><a href="http://www.testbattlecomm.com/tool/tourney_SetupRevA.php?tourney=<?php echo($Recordset1->getColumnVal("tournament_id")); ?>&gs=<?php echo($Recordset1->getColumnVal("game_system_id")); ?>">Tournament Configuration</a></li>
  <li><a href="http://www.testbattlecomm.com/tool/index.php">Tournament Home</a></li>
  <li><a href="http://www.testbattlecomm.com/tool/playerAssignment_A_3_rev.php?tourney=<?php echo $_GET['tourney']; ?>&rd=<?php echo $_GET['rd'] ?>">Configuration for this round</a></li>
</ul>
