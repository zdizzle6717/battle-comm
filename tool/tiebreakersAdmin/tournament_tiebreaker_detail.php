...
$query_WADAtournament_tiebreaker = sprintf("SELECT tourney_tiebreaker_id, match_id, `Game Title`, tiebreaker_name, tiebreaker_conditions, point_value FROM tournament_tiebreaker WHERE tourney_tiebreaker_id = %s", GetSQLValueString($Paramtourney_tiebreaker_id_WADAtournament_tiebreaker, "-1"));
...
<a name="top"></a>
	...
	<div id="WADADetails">
			...
			<tr>
				<td class="DetailsSublabel">Round ID:</td>
				<td class="DetailsPage"><?php echo($row_WADAtournament_tiebreaker['match_id']); ?></td>
			</tr>
			<tr>
				<td class="DetailsSublabel">Game Title:</td>
				<td class="DetailsPage"><?php echo($row_WADAtournament_tiebreaker['Game Title']); ?></td>
			</tr>
			<tr>
				<td class="DetailsSublabel">Tiebreaker/Mission Name:</td>
				<td class="DetailsPage"><?php echo($row_WADAtournament_tiebreaker['tiebreaker_name']); ?></td>
			</tr>
			<tr>
				<td class="DetailsSublabel">Tiebreaker/Mission Conditions:</td>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
				  ...
				  <td><input type="button" value="Top" class="" id="Top" name="Top" onclick="window.location.hash='top';" /></td>
					<td><input type="button" value="Update" class="" id="Update" name="Update" onclick="document.location.href = 'tournament_tiebreaker_update.php?tourney_tiebreaker_id=<?php echo($row_WADAtournament_tiebreaker["tourney_tiebreaker_id"]); ?>
<?php echo(isset($_GET["pageNum_WADAtournament_tiebreaker"])?"&pageNum_WADAtournament_tiebreaker=".intval($_GET["pageNum_WADAtournament_tiebreaker"]):""); ?>';" /></td>
					...
					<td><input type="button" value="Back To Results" class="" id="BackToResults" name="BackToResults" onclick="document.location.href = 'tournament_tiebreaker_results.php<?php echo(isset($_GET["pageNum_WADAtournament_tiebreaker"])?"?pageNum_WADAtournament_tiebreaker=".intval($_GET["pageNum_WADAtournament_tiebreaker"]):""); ?>';" /></td>
				   </tr>
			</table>
		</div></span>
        </fieldset>
