...
<a name="top"></a>
	...
	<div id="WADADetails">
			...
			<tr>
				<td class="DetailsSublabel">Game Category:</td>
				<td class="DetailsPage"><?php echo($row_WADAgame_categories['game_category']); ?>
...
?>
			...
			<tr>
				...
				<td class="DetailsPage"><?php echo($row_WADAgame_categories['WinPointValue']); ?></td>
			</tr>
			<tr>
				<td class="DetailsSublabel">Loss Point Value</td>
				<td class="DetailsPage"><?php echo($row_WADAgame_categories['lossPointValue']); ?></td>
			</tr>
			<tr>
				<td class="DetailsSublabel">Draw Point Value</td>
				<td class="DetailsPage"><?php echo($row_WADAgame_categories['drawPointValue']); ?></td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
				  ...
				  <td><input type="button" value="Top" class="" id="Top" name="Top" onclick="window.location.hash='top';" /></td>
					<td><input type="button" value="Update" class="" id="Update" name="Update" onclick="document.location.href = 'game_categories_update.php?game_cat_id=<?php echo($row_WADAgame_categories["game_cat_id"]); ?>
<?php echo(isset($_GET["pageNum_WADAgame_categories"])?"&pageNum_WADAgame_categories=".intval($_GET["pageNum_WADAgame_categories"]):""); ?>';" /></td>
					...
					<td><input type="button" value="Back To Results" class="" id="BackToResults" name="BackToResults" onclick="document.location.href = 'game_categories_results.php<?php echo(isset($_GET["pageNum_WADAgame_categories"])?"?pageNum_WADAgame_categories=".intval($_GET["pageNum_WADAgame_categories"]):""); ?>';" /></td>
				   </tr>
			</table>
		</div></span>
        </fieldset>
