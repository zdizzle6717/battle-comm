...
<title>BattleComm: Tournament Admin</title>
...
<div class="profilenav" onclick="toggle_visibility('account-nav');"><img src="../uploads/player/<?php echo $_SESSION['SecurityAssist_id']; ?>/{{logged_in_player_full.data[0].user_icon}}" width="37" alt=""/>
    <div id="account-nav">
        ...
        <?php } // End Show Region ?>
        <div class="mobilenav">
            <a href="#menu" id="toggle" class="off"><span></span></a>
<nav class="topnav top-menu" id="menu" role="navigation">
    <ul>
        <li class="home"><a href="/index.php" ><h2 id="phoneOnly">HOME</h2></a></li>
    ...
    <div class="my-profile-button"><a href="../players/index.php"><img src="../images/BC_App_MyProfile.png" alt="BattleComm"></a></div><div class="create-match-button"><a href="../match.php"><img src="../images/BC_App_CreateMatch.png" alt="BattleComm"></a></div>
</div>
            <?php } // End Show Region ?>
        </div>
    </div>     
...
<a href="https://www.facebook.com/battlecomm"><span class="symbol face" style="font-size: 38px;">&#xe427;</span></a><a href="https://twitter.com/Battle_Comm"><span class="symbol twit" style="font-size: 38px;">&#xe286;</span></a><a href="https://instagram.com/Battle_Comm"><span class="symbol insta" style="font-size: 38px;">&#xe500;</span></a>
</div>
                </div>
            </div>
...
<div class="copyright">© 2015 Battle-Comm.com. All Rights Reserved.
  ...
  <h4>All copyrights belong to their respective owners. Images and text owned by other copyright holders are used here under the guidelines of the Fair Use provisions of United States Copyright Law.</h4>
        ...
        <script>
			$('.open-popup-link').magnificentPopup({
			  type:'inline',
	...
	<script><?php include ("../Scripts/prefixfree.min.js"); ?></script>
