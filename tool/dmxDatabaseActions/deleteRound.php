...
$cfg = <<<JSON
{"type": "delete", "table": "tournament_rounds", "values": [], "wheres": [{"table": "tournament_rounds", "column": "rounds_id", "bool": "and", "operator": "=", "value": {"from": "form", "value": "rounds_id", "required": true, "default": ""}}]}
JSON;
