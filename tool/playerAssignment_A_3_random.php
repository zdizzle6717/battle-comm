...
mysql_select_db($database_local, $local);
$query_tournamentPlayers = sprintf("SELECT * FROM tournament_players INNER JOIN club ON tournament_players.clubID=club.club_key WHERE tournament_id = %s ORDER BY RAND(), totalScore DESC", GetSQLValueString($colname_tournamentPlayers, "int"));
...
<p>Total # of Registered Players: <?php echo $totalRows_tournamentPlayers ?>  | <a href="playerAssignment_A_3_rev.php?tourney={{GameTourneyJoin.data[0].tournament_id}}&rd={{rounds_id}}"">Assign Players </a>
 <br/>
</p>
