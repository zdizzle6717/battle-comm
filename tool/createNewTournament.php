...
<?php include '../Templates/parts/header.php'; ?>
		<?php include '../Templates/parts/container-top.php'; ?>
              ...
              <div id="PlayerNav"> <a href="/players/index.php">Player Home</a> | <a href="/players/mydashboard.php">My Dashboard</a> |
                <?php if(WA_Auth_RulePasses("tourneyAdmin")){ // Begin Show Region ?>
                <a href="index.php">Tournament Admin</a> |
                <?php } // End Show Region ?>
                <a href="../players/user_login_update.php?id=<?php echo $_SESSION['SecurityAssist_id']; ?>">Edit Account</a> | <a href="../players/editProfileA.php">Edit Profile (A)</a> |
              ...
              <p>
                <!-- Start Formoid form-->
                <link rel="stylesheet" href="tournamentnew_files/formoid1/formoid-default-skyblue.css" type="text/css" />
<form enctype="multipart/form-data" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666; method="post">
                <div class="title">
                  <h2>My form</h2>
                </div>
                <div class="element-input">
                  <label class="title">Tournament Name</label>
                  <input class="large" type="text" name="input" />
                </div>
                <div class="element-date">
                  <label class="title">Start Date</label>
                  <input class="small" data-format="yyyy-mm-dd" type="date" name="date" placeholder="yyyy-mm-dd"/>
                </div>
                <div class="element-input">
                  <label class="title">Start Time</label>
                  <input class="small" type="text" name="input1" />
                </div>
                <div class="element-date">
                  <label class="title">End Date</label>
                  <input class="small" data-format="yyyy-mm-dd" type="date" name="date1" placeholder="yyyy-mm-dd"/>
                </div>
                <div class="element-input">
                  <label class="title">EndTime</label>
                  <input class="small" type="text" name="input2" />
                </div>
                <div class="element-select">
                  <label class="title">Game Store Location</label>
                      ...
                      <label class="subtitle">Address Line 2</label>
                        ...
                        <label class="subtitle">City</label>
                          ...
                          <label class="subtitle">State / Province / Region</label>
                            ...
                            <input  type="text" maxlength="15" name="address[zip]" />
                ...
                <div class="element-phone">
                  <label class="title">Tournament Phone</label>
                  <input class="small" type="tel" pattern="\d{3}-\d{3}-\d{4}" maxlength="24" name="phone" placeholder="XXX-XXX-XXXX" value=""/>
                </div>
                <div class="element-email">
                  <label class="title">Tournament Email</label>
                  <input class="medium" type="email" name="email" value="" />
                </div>
                <div class="element-url">
                  <label class="title">Tournament Website</label>
                  <input class="medium" type="url" name="url" value="http://" />
                </div>
                <div class="element-file">
                  <label class="title">Tournament Logo/Icon</label>
                ...
                <div class="element-select">
                  <label class="title">Game System</label>
                ...
                <div class="element-input">
                  <label class="title">Tournament Rounds</label>
                  <input class="small" type="text" name="input3" />
                </div>
                <div class="element-input">
                  <label class="title">Factions Cap</label>
                  <input class="small" type="text" name="input4" />
                </div>
                <div class="submit">
                  <input type="submit" value="Submit"/>
                </div>
              </form>
              <script type="text/javascript" src="tournamentnew_files/formoid1/formoid-default-skyblue.js"></script>
              <!-- Stop Formoid form-->
              <p></p>
