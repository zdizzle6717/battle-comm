...
<a name="top"></a>
	...
	<div id="WADADetails">
			...
			<tr>
				<td class="DetailsSublabel">Username:</td>
				<td class="DetailsPage"><?php echo($row_WADAuser_profile['username']); ?></td>
			</tr>
			<tr>
				<td class="DetailsSublabel">First Name:</td>
				<td class="DetailsPage"><?php echo($row_WADAuser_profile['user_firstName']); ?></td>
			</tr>
			<tr>
				<td class="DetailsSublabel">Last Name</td>
				<td class="DetailsPage"><?php echo($row_WADAuser_profile['user_lastName']); ?></td>
			</tr>
			<tr>
				<td class="DetailsSublabel">Email:</td>
				<td class="DetailsPage"><?php echo($row_WADAuser_profile['user_email']); ?></td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
				  ...
				  <td><input type="button" value="Top" class="" id="Top" name="Top" onclick="window.location.hash='top';" /></td>
					<td><input type="button" value="Update" class="" id="Update" name="Update" onclick="document.location.href = 'user_profile_update.php?iduser_profile=<?php echo($row_WADAuser_profile["iduser_profile"]); ?>
<?php echo(isset($_GET["pageNum_WADAuser_profile"])?"&pageNum_WADAuser_profile=".intval($_GET["pageNum_WADAuser_profile"]):""); ?>';" /></td>
					...
					<td><input type="button" value="Back To Results" class="" id="BackToResults" name="BackToResults" onclick="document.location.href = 'user_profile_results.php<?php echo(isset($_GET["pageNum_WADAuser_profile"])?"?pageNum_WADAuser_profile=".intval($_GET["pageNum_WADAuser_profile"]):""); ?>';" /></td>
				   </tr>
			</table>
		</div></span>
        </fieldset>
