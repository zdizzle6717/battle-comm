...
<!-- End User Level Navigation -->
			<h2>BattleComm.com Tourney Tool</h2>
...
<p>Total # of Registered Players: <?php echo $totalRows_tournamentPlayers ?> </p></p>
         <p> Counter= <?php echo $tabCounter; ?> TabIncrement=<?php echo $tabIncrement; ?></p> 
           <p> <form action="" method="post" name="RoundRegistration" id="RoundRegistration">    
...
?>
            ...
            <td>Match 
              ...
              <p> Counter= <? echo $tabCounter; ?> TabIncrement=<? echo $tabIncrement; ?></p> 
              </td>
            <td>Table 
...
?>
	   ...
	   | <a href="tourney_SetupRevA.php?=<?php echo $row_tournamentGameJoin['tournament_id']; ?>&gs=<?php echo $row_tournamentGameJoin['game_system_id']; ?>">Back to Round Configuration </a></p>
                      </div>
                </div>
