...
<form class="Basic_Defaultmod" id="Search_Basic_Defaultmod" name="Search_Basic_Defaultmod" method="get" action="index.php">
  ...
  <input id="tournament_startDate" name="tournament_startDate" type="text" value="<?php echo((isset($_GET["tournament_startDate"])?$_GET["tournament_startDate"]:"")); ?>" class="formTextfield_Medium" tabindex="2" title="Please enter a value.">
	   <?php
...
?><span class="serverInvalidState" id="tournament_startDate_ServerError">Please enter a value.</span><?php //WAFV_Conditional tournament_search.php tournamentsearch(1:)
  ...
  <input id="Tournament_endDate" name="Tournament_endDate" type="text" value="<?php echo((isset($_GET["Tournament_endDate"])?$_GET["Tournament_endDate"]:"")); ?>" class="formTextfield_Medium" tabindex="3" title="Please enter a value.">
	   <?php
if (ValidatedField('tournamentsearch','tournamentsearch'))  {
