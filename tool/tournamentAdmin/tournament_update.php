...
?>
	     ...
	     <?php //WAFV_Conditional tournament_update.php tournamentupdate(1:)
    }
  }
}?>
    </div> 
...
?>
	     ...
	     <?php //WAFV_Conditional tournament_update.php tournamentupdate(2:)
    }
  }
}?>
    </div> 
...
?>
	     ...
	     <?php //WAFV_Conditional tournament_update.php tournamentupdate(3:)
    }
  }
}?>
    </div> 
...
?>
	     ...
	     <?php //WAFV_Conditional tournament_update.php tournamentupdate(4:)
    }
  }
}?>
    </div> 
...
?>
	     ...
	     <?php //WAFV_Conditional tournament_update.php tournamentupdate(5:)
    }
  }
}?>
    </div> 
...
?>
	     ...
	     <?php //WAFV_Conditional tournament_update.php tournamentupdate(6:)
    }
  }
}?>
    </div> 
...
?>
	     ...
	     <?php //WAFV_Conditional tournament_update.php tournamentupdate(7:)
    }
  }
}?>
    </div> 
  ...
  <input id="tournament_admin_name" name="tournament_admin_name" type="text" value="<?php echo((isset($_GET["invalid"])?ValidatedField("tournamentupdate","tournament_admin_name"):"".$row_WADAtournament["tournament_admin_name"]."")); ?>" class="formTextfield_Medium" tabindex="15" title="Please enter a value.">
    ...
    <div class="lineGroup"> <label for="tournament_info" class="sublabel" > Tournament Information:</label><div style="display:inline-block">
      <?php
