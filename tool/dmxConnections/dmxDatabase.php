...
function getAllTables() {
	...
	if ($driver == 'sqlite') {
		...
		if ($driver == 'mysql') {
			...
			$results = getResult("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'public' AND TABLE_CATALOG = '$database' AND TABLE_TYPE = 'BASE TABLE'");
		} else {
...
function getAllViews() {
	...
	if ($driver == 'sqlite') {
		...
		if ($driver == 'mysql') {
			...
			$results = getResult("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'public' AND TABLE_CATALOG = '$database' AND TABLE_TYPE = 'VIEW'");
		} else {
...
function getDb() {
	...
	if ($driver == 'sqlite') {
		...
		if ($driver == 'mysql') {
			...
			$results = getResult("SELECT TABLE_NAME, TABLE_TYPE FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'public' AND TABLE_CATALOG = '$database' AND TABLE_TYPE IN ('BASE TABLE', 'VIEW')");
		} else {
