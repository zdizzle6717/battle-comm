...
<head>
	...
	<meta property="og:title" content="Battle-Comm: Login"/>
	<meta property="og:url" content="http://www.beta.battle-comm.net/loginA.php"/>
...
<div class="two_column_1">
    <form class="formoid-default-skyblue side_by_side" style="max-width:590px;min-width:150px">
                <h2 style="color:black;background:rgba(37, 100, 119, 0.6);">REGISTER</h2>
                <h4>WELCOME TO BATTLE-COMM...the portal to find all levels of friendly, local, table-top gaming. With a long running list of supported table-top gaming systems, Battle-comm is a community of individuals making connections through competition.<br/><br/>  Schedule a tournament, record stats, match up with local players, and compete at the national level.  You'll also have the opportunity to earn ranking, achievements, and BC Reward Points to trade-in for related products!</h4>
            <h3 class="right" style="margin-bottom:15px;"><a href="#test-popup" class="open-popup-link" >&rarr;Supported Platforms</a></h3>
        ...
        <h2 style="color:black;background:rgba(37, 100, 119, 0.6);">Sign Up</h2>
        <h5><a href="/registrationA.php">&rarr;Player Registration</a></h5>
	</form>
</div>
              </div>
                    </div>
