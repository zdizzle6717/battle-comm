...
class Grid {
    ...
    public function ExtractViewMode() {
        ...
        } elseif (GetApplication()->IsSessionVariableSet($sessionVariableKey) && !$this->isMaster()) {
    ...
    function ProcessMessages($processFilters = true) {
        ...
        if ($processFilters && $filterApplied) {
