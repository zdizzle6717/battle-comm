...
$data = json_decode($jsondata, true);
    ...
    $shippingStreet = $data['customer']['shippingStreet'];
    $shippingApartment = $data['customer']['shippingApartment'];
    $shippingCity = $data['customer']['shippingCity'];
    $shippingState = $data['customer']['shippingState'];
    $shippingZip = $data['customer']['shippingZip'];
    $shippingCountry = $data['customer']['shippingCountry'];

    $sql = "INSERT INTO product_orders(id, customerId, created, updated, status, orderDetails, orderTotal, customerFullName, customerEmail, phone, shippingStreet, shippingApartment, shippingCity, shippingState, shippingZip, shippingCountry)
        VALUES('$id', '$customerId', NOW(), NOW(), '$status', '$orderDetails', '$orderTotal', '$customerFullName', '$customerEmail', '$phone', '$shippingStreet', '$shippingApartment', '$shippingCity', '$shippingState', '$shippingZip', '$shippingCountry' )";
