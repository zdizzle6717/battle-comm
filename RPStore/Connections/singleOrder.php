...
$result = $battlecomm_sqli->query("SELECT id, customerId, updated, status, orderDetails, orderTotal, customerFullName, customerEmail, phone, shippingStreet, shippingApartment, shippingCity, shippingState, shippingZip, shippingCountry FROM product_orders WHERE id='$currentOrder'");
...
while($rs = $result->fetch_array(MYSQLI_ASSOC)) {
    ...
    $outp .= '"customerEmail":"' . $rs["customerEmail"] . '",';
    $outp .= '"phone":"' . $rs["phone"] . '",';
