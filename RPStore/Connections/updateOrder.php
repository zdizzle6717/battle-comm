...
$data = json_decode($jsondata, true);
    ...
    $sql = "UPDATE product_orders
        SET customerId = '$customerId', updated = NOW(), status = '$status', orderDetails = '$orderDetails', orderTotal = '$orderTotal', customerFullName = '$customerFullName', customerEmail = '$customerEmail', phone = '$phone', shippingStreet = '$shippingStreet', shippingApartment = '$shippingApartment', shippingCity = '$shippingCity', shippingState = '$shippingState', shippingZip = '$shippingZip', shippingCountry = '$shippingCountry'
