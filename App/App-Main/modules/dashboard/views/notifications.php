...
<div class="two_column_1">
	...
	<div ng-if="Notifications.notifications.length > 0" class="notification-list">
		<div ng-repeat="notification in Notifications.notifications track by $index" class="group">
		  <div class="message" ng-if="notification.type === 'friendRequest'">New Ally Request from {{notification.fromUsername}}</div>
		  <div class="message" ng-if="notification.type === 'friendshipAccepted'">{{notification.fromUsername}} accepted your ally request.</div>
		  <div class="actions">
