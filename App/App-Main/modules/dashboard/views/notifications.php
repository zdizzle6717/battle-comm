...
<div class="two_column_1">
	...
	<div ng-if="Notifications.notifications.length > 0" class="notification-list">
		<div ng-repeat="notification in Notifications.notifications track by $index" class="group">
		  <div class="message" ng-if="notification.type === 'friendRequest'">New Friend Request from {{notification.fromName}}</div>
		  <div class="message" ng-if="notification.type === 'friendshipAccepted'">{{notification.fromName}} accepted your friend request.</div>
		  <div class="actions">
