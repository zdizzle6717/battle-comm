...
<div class="full_width">
	<h2>Allies <a ui-sref="allyList({'playerId': Profile.currentUser.id})">View All</a></h2>
...
<div class="full_width">
	...
	<h3 class="text-center" ng-if="Profile.currentUser.GameSystemRankings.length < 1">Submit game results to a Battle-Comm participating event/venue administrator to have your ranking submitted to the BC leaderboards.</h3>
	<div class="full_width" ng-repeat="gameRanking in Profile.currentUser.GameSystemRankings" ng-if="Profile.currentUser.GameSystemRankings.length > 0">
