...
PlayerRankingController.$inject = ['$rootScope', '$state', '$stateParams', 'PlayerService', 'AuthService'];
function PlayerRankingController($rootScope, $state, $stateParams, PlayerService, AuthService) {
    let controller = this;
