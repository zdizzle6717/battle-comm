...
<title>BattleComm: Submit Score</title>
...
?></td>
  ...
  <input name="tourneyPlayerID" type="hidden" id="tourneyPlayerID" form="player_results_submit" value="<?php echo($TourneyGamePlayer->getColumnVal("tourney_game_player_id")); ?>"><?php echo($TourneyGamePlayer->getColumnVal("tourney_game_player_id")); ?>
        <p>
        <p onMouseOver="MM_showHideLayers('SubmitScore','','show')"><strong>To Submit Your Score                </strong>        
        <div id="generate" name="generate" style="display:inline;"><input name="submit" type="submit" id="submit" form="player_results_submit" formaction="submitscoreB.php?td=<?php echo($tournament->getColumnVal("tournament_id")); ?>&rd=<?php echo($rounds->getColumnVal("rounds_id")); ?>&gs=<?php echo($TourneyGamePlayer->getColumnVal("Game_session")); ?>&tbl=<?php echo($TourneyGamePlayer->getColumnVal("table_id")); ?>" formmethod="POST" value="Generate Results"></div>
  <div id="submit" name="submit" style="display:none;"><input name="SubmitScore" type="submit" id="SubmitScore" formaction="#" value="Submit Score">
  </div>
		</p></p>
            </p></p></form></p>
