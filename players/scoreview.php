...
<title>BattleComm: Scoreview</title>
...
<?php include '../Templates//parts/header.php'; ?>
		<?php include '../Templates/parts/container-top.php'; ?>
			...
			<h2>Submitted Score for	<?php echo($tournament->getColumnVal("tournament_name")); ?>/<?php echo($rounds->getColumnVal("Round_Title")); ?></h2>
			<p>Outcome: <?php echo($TourneyGamePlayer->getColumnVal("game_result")); ?></p>
			<p>Game Points: <?php echo($TourneyGamePlayer->getColumnVal("game_points")); ?></p>
			<p>Mission Points: <?php echo($TourneyGamePlayer->getColumnVal("mission_points")); ?></p>
			<p>Total for Round: <?php echo($TourneyGamePlayer->getColumnVal("total_points")); ?></p>
			<p><a href="tournamentResultDetails.php?td=<?php echo($tournament->getColumnVal("tournament_id")); ?>">Tournament Overview</a></p>
