...
if (isset($_POST["Update"]) || isset($_POST["Update_x"])) // Trigger
{
  ...
  $WA_redirectURL = "profileEdit.php?iduser_profile=".((isset($_POST["WADAUpdateRecordID"]))?$_POST["WADAUpdateRecordID"]:"")  ."".(isset($_GET["pageNum_WADAuser_profile"])?"&pageNum_WADAuser_profile=".intval($_GET["pageNum_WADAuser_profile"]):"")  ."";
