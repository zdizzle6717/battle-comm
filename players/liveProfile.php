		...
		<?php include '../Templates/parts/container-top.php'; ?>
        	<?php include '../Templates/includes/user-navigation.php'; ?>
                <div class="two_column_1">
                  <h2 style="text-align:center;">Player Bio | {{LoggedInUser.data[0].firstName}} {{LoggedInUser.data[0].lastName}}</h2>
                ...
                <div class="two_column_1">
                	<h1 class="center" style="text-transform: initial;color: gold;text-shadow: 1px 1px 5px black;"><span class="glyphicon glyphicon-user" style="font-size:.7em"></span> {{LoggedInUser.data[0].user_handle}}</h1>
                	<div class="center"><br/><img src="/uploads/player/<?php echo $_SESSION['SecurityAssist_id']; ?>/{{logged_in_player_full.data[0].user_icon}}" alt="" class="shadow" width="220px"/></div>
        			<div class="center">
                        <ul class="inline">
                            <li class="item"><a class="" href="#" target="_self">Send a Message (pending)</a></li>
                            <li><a href="#">Create Match (pending)</a></li>
                            <li><a href="#">Add as Friend (pending)</a></li>
                        </ul>
                    </div>
                </div>
