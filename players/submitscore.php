...
?></td>
  ...
  <div id="generate" name="generate" style="display:inline;"><input name="submit" type="submit" id="submit" form="player_results_submit" formaction="#" formmethod="POST" onClick="MM_showHideLayers('SubmitScore','','show');MM_showHideLayers('submit','','hide')" onMouseDown="MM_changeProp('submit','','display','inline','DIV')" value="Generate Results"></div>
