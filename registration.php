...
<div id="RegistrationContainer" class="WAATK">
  <div id="Registration_Basic_Default_ProgressWrapper">
    <form class="Basic_Default" id="Registration_Basic_Default" name="Registration_Basic_Default" method="post" action="<?php echo (htmlentities($_SERVER["PHP_SELF"], ENT_QUOTES)); ?>">
      <fieldset class="Basic_Default" id="Registration">
        <legend class="groupHeader">New PlayerRegistration</legend>
...
if (ValidatedField('registration','registration'))  {
  if ((strpos((",".ValidatedField("registration","registration").","), "," . "1" . ",") !== false || "1" == "") || (strpos((",".ValidatedField("registration","registration").","), "," . "2" . ",") !== false || "2" == ""))  {
    if (!(false))  {
?>
            <span class="serverInvalidState" id="Registration_group_Email_Address_ServerError">Please enter a value.</span>
...
if (ValidatedField('registration','registration'))  {
  if ((strpos((",".ValidatedField("registration","registration").","), "," . "6" . ",") !== false || "6" == "") || (strpos((",".ValidatedField("registration","registration").","), "," . "7" . ",") !== false || "7" == ""))  {
    if (!(false))  {
?>
            <span class="serverInvalidState" id="Registration_group_6_Handle_Nickname_ServerError">Please enter a value.</span>
