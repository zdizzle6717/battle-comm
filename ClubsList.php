...
<script type="text/javascript">
  /* dmxDataSet name "ClubsList" */
       jQuery.dmxDataSet(
         {"id": "ClubsList", "url": "dmxDatabaseSources/clubsList.php", "data": {"limit": "25"}, "dataSourceType": "database", "dataType": "jsonp"}
       );
  /* END dmxDataSet name "ClubsList" */
</script>
</head>
            	...
            	<div class="full_content col" >
                    ...
                    <div class="frame_content row">
                        ...
                        <div class="frame_center col">
                        	<h1 class="no_shadow center blue">Clubs</h1>
                        	<ul>
                        	  
                        	    <div data-binding-id="repeat1" data-binding-repeat-children="{{ClubsList.data}}"><li>
                        	 <strong><a href="clubDetail.php?ck={{club_key}}">{{club_name}}</a></strong>- {{venue_Name}}-- <a href="#">[Join]</a></li></div>
                      	  </ul>
                        </div>
                    </div>
