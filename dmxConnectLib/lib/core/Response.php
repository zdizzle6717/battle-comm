...
class Response
{
    ...
    public function setCookie($name, $value, $options) {
        ...
        if (isset($options->expires)) {
            ...
            $expires = date(DATE_COOKIE, strtotime($sign . abs($options->expires) . ' days'));
    ...
    public function json($data) {
        ...
        if (isset($this->app->request->get['callback'])) {
            $this->setContentType('text/javascript');
            $buffer = $this->app->request->get['callback'] . '(' . $buffer . ')';
        } else {
    ...
    public function end($status = NULL, $buffer = NULL) {
        ...
        //header($protocol . ' ' . $this->status . ' ' . (isset(self::$statusText[$this->status]) ? self::$statusText[$this->status] : $this->status));
